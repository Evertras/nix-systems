...
in
{
  ...
  config = mkIf cfg.enable {
          ...
          startup =
            ...
            (
              ...
              ++ [
                ...
                {
                  command = "while ! styli.sh -s '${startupWallpaperTerm}'; do sleep 1; done";
                  notification = false;
                }
              ]
              ++ postCommands
            ...
            let
              ...
              kbBase =
                let
                  ...
                  i3LockFontFlags = strings.concatStringsSep " " (
                    map (
                      category: "--${category}-font '${theme.fonts.main.name}' --${category}-size 150"
                    ) i3LockCategories
                  );
              ...
              kbBluetooth =
                if (cfgAudio.headphonesMacAddress != null) then
                  {
              ...
              allOverrides = kbBase // kbVolume // kbBluetooth // cfg.keybindOverrides;
            in
            mkOptionDefault allOverrides;
            ...
            let
              mkBarConfig =
                ...
                }:
                {
                  ...
                  extraConfig =
                    let
                      outputStrings = map (output: "output ${output}") outputs;
                    in
                    ''
                      separator_symbol " | "
                      ${concatStringsSep "\n" outputStrings}
    ...
    programs.i3status =
      let
        networkingModule =
          if cfg.monitorNetworkWireless then
            {
